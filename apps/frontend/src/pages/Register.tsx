...
export function Register() {
  ...
  const registerMutation = useMutation({
    mutationFn: async () => {
      // Validate inputs locally using shared RegistrationSchema
      const parseResult = RegistrationSchema.safeParse({ username, password });
      ...
      <div className="max-w-md w-full space-y-8 glass-panel p-8 rounded-2xl border border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center relative">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Join the prediction league for FIFA World Cup 2026
          </p>
        </div>

        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-6 text-center space-y-3 relative">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Alphanumeric & underscores, 3-20 chars"
                  />
                </div>
              </div>
